...
const products = [
    ...
    { id: 11, name: 'AMAZON', price: 1000, image: amazonImage },
    { id: 12, name: 'MYNTRA', price: 1000, image: myntraImage },
...
export default function WeddingShop() {
    ...
    return (
        <div className="container">
            ...
            <h1 className="title">Please add gift to cart from below then scroll to the bottom!</h1>
            ...
            <h3 className="title">Please Enter you name and relation</h3>
